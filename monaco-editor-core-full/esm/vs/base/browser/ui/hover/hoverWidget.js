...
export function getHoverAccessibleViewHint(shouldHaveHint, keybinding) {
    return shouldHaveHint && keybinding ? localize(15, "Inspect this in the accessible view with {0}.", keybinding) : shouldHaveHint ? localize(16, "Inspect this in the accessible view via the command Open Accessible View which is currently not triggerable via keybinding.") : '';
}
