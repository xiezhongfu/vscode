...
registerColor('actionBar.toggledBackground', inputActiveOptionBackground, localize(1784, 'Background color for toggled action items in action bar.'));
const ActionWidgetContextKeys = {
    Visible: new RawContextKey('codeActionMenuVisible', false, localize(1785, "Whether the action widget list is visible"))
};
...
registerAction2(class extends Action2 {
    constructor() {
        super({
            ...
            title: localize2(1786, "Hide action widget"),
...
registerAction2(class extends Action2 {
    constructor() {
        super({
            ...
            title: localize2(1787, "Select previous action"),
            precondition: ActionWidgetContextKeys.Visible,
            keybinding: {
                weight,
...
registerAction2(class extends Action2 {
    constructor() {
        super({
            ...
            title: localize2(1788, "Select next action"),
            precondition: ActionWidgetContextKeys.Visible,
            keybinding: {
                weight,
...
registerAction2(class extends Action2 {
    constructor() {
        super({
            ...
            title: localize2(1789, "Accept selected action"),
            precondition: ActionWidgetContextKeys.Visible,
            keybinding: {
                weight,
...
registerAction2(class extends Action2 {
    constructor() {
        super({
            ...
            title: localize2(1790, "Preview selected action"),
            precondition: ActionWidgetContextKeys.Visible,
            keybinding: {
                weight,
