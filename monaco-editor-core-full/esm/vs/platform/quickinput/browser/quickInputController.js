...
let QuickInputController = class QuickInputController extends Disposable {
    ...
    getUI(showInActiveContainer) {
        ...
        const checkAll = this._register(new TriStateCheckbox(localize(1946, "Toggle all checkboxes"), false, { ...defaultCheckboxStyles, size: 15 }));
        ...
        const visibleCount = this._register(new CountBadge(visibleCountContainer, { countFormat: localize(1947, "{0} Results") }, this.styles.countBadge));
        const countContainer = dom.append(filterContainer, $('.quick-input-count'));
        countContainer.setAttribute('aria-live', 'polite');
        const count = this._register(new CountBadge(countContainer, { countFormat: localize(1948, "{0} Selected") }, this.styles.countBadge));
        ...
        ok.label = localize(1949, "OK");
        this._register(ok.onDidClick(e => {
            this.onDidAcceptEmitter.fire();
        }));
        const customButtonContainer = dom.append(headerContainer, $('.quick-input-action'));
        const customButton = this._register(new Button(customButtonContainer, { ...this.styles.button, supportIcons: true }));
        customButton.label = localize(1950, "Custom");
    ...
    show(controller) {
        ...
        backButton.tooltip = backKeybindingLabel ? localize(1951, "Back ({0})", backKeybindingLabel) : localize(1952, "Back");
