...
export const InQuickInputContextKey = new RawContextKey(inQuickInputContextKeyValue, false, localize(1931, "Whether keyboard focus is inside the quick input control"));
...
export const QuickInputAlignmentContextKey = new RawContextKey(quickInputAlignmentContextKeyValue, 'top', localize(1932, "The alignment of the quick input"));
export const quickInputTypeContextKeyValue = 'quickInputType';
export const QuickInputTypeContextKey = new RawContextKey(quickInputTypeContextKeyValue, undefined, localize(1933, "The type of the currently visible quick input"));
export const endOfQuickInputBoxContextKeyValue = 'cursorAtEndOfQuickInputBox';
export const EndOfQuickInputBoxContextKey = new RawContextKey(endOfQuickInputBoxContextKeyValue, false, localize(1934, "Whether the cursor in the quick input is at the end of the input box"));
export const endOfQuickInputBoxContext = ContextKeyExpr.has(endOfQuickInputBoxContextKeyValue);
export const backButton = {
    iconClass: ThemeIcon.asClassName(Codicon.quickInputBack),
    tooltip: localize(1935, "Back"),
    handle: -1 // TODO
};
export class QuickInput extends Disposable {
    static { this.noPromptMessage = localize(1936, "Press 'Enter' to confirm your input or 'Escape' to cancel"); }
    constructor(ui) {
        super();
        this.ui = ui;
    ...
    getSteps() {
        if (this.step && this.totalSteps) {
            return localize(1937, "{0}/{1}", this.step, this.totalSteps);
        }
        if (this.step) {
...
export class QuickPick extends QuickInput {
    static { this.DEFAULT_ARIA_LABEL = localize(1938, "Type to narrow down results."); }
    constructor(ui) {
        super(ui);
        this._value = '';
    ...
    get okLabel() {
        return this._okLabel ?? localize(1939, "OK");
    }
    set okLabel(okLabel) {
...
export class InputBox extends QuickInput {
    ...
    set prompt(prompt) {
        this._prompt = prompt;
        this.noValidationMessage = prompt
            ? localize(1940, "{0} (Press 'Enter' to confirm or 'Escape' to cancel)", prompt)
