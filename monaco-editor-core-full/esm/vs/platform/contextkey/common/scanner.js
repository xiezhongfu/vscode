...
function hintDidYouMean(...meant) {
    switch (meant.length) {
        case 1:
            return localize(1822, "Did you mean {0}?", meant[0]);
        case 2:
            return localize(1823, "Did you mean {0} or {1}?", meant[0], meant[1]);
        case 3:
            return localize(1824, "Did you mean {0}, {1} or {2}?", meant[0], meant[1], meant[2]);
        default: // we just don't expect that many
            return undefined;
    }
}
const hintDidYouForgetToOpenOrCloseQuote = localize(1825, "Did you forget to open or close the quote?");
const hintDidYouForgetToEscapeSlash = localize(1826, "Did you forget to escape the '/' (slash) character? Put two backslashes before it to escape, e.g., '\\\\/\'.");
/**
