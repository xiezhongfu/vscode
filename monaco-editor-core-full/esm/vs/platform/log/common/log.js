...
export function LogLevelToLocalizedString(logLevel) {
    switch (logLevel) {
        case LogLevel.Trace: return { original: 'Trace', value: nls.localize(1906, "Trace") };
        case LogLevel.Debug: return { original: 'Debug', value: nls.localize(1907, "Debug") };
        case LogLevel.Info: return { original: 'Info', value: nls.localize(1908, "Info") };
        case LogLevel.Warning: return { original: 'Warning', value: nls.localize(1909, "Warning") };
        case LogLevel.Error: return { original: 'Error', value: nls.localize(1910, "Error") };
        case LogLevel.Off: return { original: 'Off', value: nls.localize(1911, "Off") };
    }
}
