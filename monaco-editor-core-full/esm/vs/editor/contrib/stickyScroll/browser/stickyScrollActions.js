...
export class ToggleStickyScroll extends EditorAction2 {
    constructor() {
        super({
            ...
            title: {
                ...localize2(1571, "Toggle Editor Sticky Scroll"),
                mnemonicTitle: localize(1567, "&&Toggle Editor Sticky Scroll"),
            },
            metadata: {
                description: localize2(1572, "Toggle/enable the editor sticky scroll which shows the nested scopes at the top of the viewport"),
            },
            category: Categories.View,
            toggled: {
                condition: ContextKeyExpr.equals('config.editor.stickyScroll.enabled', true),
                title: localize(1568, "Sticky Scroll"),
                mnemonicTitle: localize(1569, "&&Sticky Scroll"),
            },
            menu: [
...
export class FocusStickyScroll extends EditorAction2 {
    constructor() {
        super({
            ...
            title: {
                ...localize2(1573, "Focus Editor Sticky Scroll"),
                mnemonicTitle: localize(1570, "&&Focus Editor Sticky Scroll"),
            },
...
export class SelectNextStickyScrollLine extends EditorAction2 {
    constructor() {
        super({
            ...
            title: localize2(1574, "Select the next editor sticky scroll line"),
...
export class SelectPreviousStickyScrollLine extends EditorAction2 {
    constructor() {
        super({
            ...
            title: localize2(1575, "Select the previous sticky scroll line"),
            precondition: EditorContextKeys.stickyScrollFocused.isEqualTo(true),
            keybinding: {
                weight,
...
export class GoToStickyScrollLine extends EditorAction2 {
    constructor() {
        super({
            ...
            title: localize2(1576, "Go to the focused sticky scroll line"),
            precondition: EditorContextKeys.stickyScrollFocused.isEqualTo(true),
            keybinding: {
                weight,
...
export class SelectEditor extends EditorAction2 {
    constructor() {
        super({
            ...
            title: localize2(1577, "Select Editor"),
            precondition: EditorContextKeys.stickyScrollFocused.isEqualTo(true),
            keybinding: {
                weight,
