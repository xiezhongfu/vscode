...
export const ctxHasSymbols = new RawContextKey('hasSymbols', false, localize(1213, "Whether there are symbol locations that can be navigated via keyboard-only."));
...
let SymbolNavigationService = class SymbolNavigationService {
    ...
    _showMessage() {
        ...
        const message = kb
            ? localize(1214, "Symbol {0} of {1}, {2} for next", this._currentIdx + 1, this._currentModel.references.length, kb.getLabel())
            : localize(1215, "Symbol {0} of {1}", this._currentIdx + 1, this._currentModel.references.length);
