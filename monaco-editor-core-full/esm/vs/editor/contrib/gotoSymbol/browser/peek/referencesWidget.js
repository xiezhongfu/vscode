...
let ReferenceWidget = class ReferenceWidget extends peekView.PeekViewWidget {
    ...
    _fillBody(containerElement) {
        ...
        this._previewNotAvailableMessage = this._instantiationService.createInstance(TextModel, nls.localize(1202, "no preview available"), PLAINTEXT_LANGUAGE_ID, TextModel.DEFAULT_CREATION_OPTIONS, null);
        // tree
    ...
    _onNewModel() {
        ...
        if (this._model.isEmpty) {
            this.setTitle('');
            this._messageContainer.innerText = nls.localize(1203, "No results");
    ...
    async _revealReference(reference, revealParent) {
        ...
        if (reference.uri.scheme !== Schemas.inMemory) {
            ...
            this.setTitle(nls.localize(1204, "References"));
        }
