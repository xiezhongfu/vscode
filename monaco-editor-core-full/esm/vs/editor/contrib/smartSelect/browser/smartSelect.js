...
class GrowSelectionAction extends AbstractSmartSelect {
    constructor() {
        super(true, {
            ...
            label: nls.localize2(1523, "Expand Selection"),
            ...
            menuOpts: {
                ...
                group: '1_basic',
                title: nls.localize(1521, "&&Expand Selection"),
                order: 2
            }
        });
    }
...
class ShrinkSelectionAction extends AbstractSmartSelect {
    constructor() {
        super(false, {
            ...
            label: nls.localize2(1524, "Shrink Selection"),
            precondition: undefined,
            kbOpts: {
                kbExpr: EditorContextKeys.editorTextFocus,
            ...
            menuOpts: {
                menuId: MenuId.MenubarSelectionMenu,
                group: '1_basic',
                title: nls.localize(1522, "&&Shrink Selection"),
                order: 3
            }
        });
    }
