...
let AbstractGotoSymbolQuickAccessProvider = class AbstractGotoSymbolQuickAccessProvider extends AbstractEditorNavigationQuickAccessProvider {
    ...
    provideWithoutTextEditor(picker) {
        this.provideLabelPick(picker, localize(1468, "To go to a symbol, first open a text editor with symbol information."));
    ...
    doProvideWithoutEditorSymbols(context, model, picker, token) {
        ...
        this.provideLabelPick(picker, localize(1469, "The active text editor does not provide symbol information."));
            ...
            try {
                ...
                if (items.length > 0) {
                    ...
                    if (query.original.length > 0) {
                        this.provideLabelPick(picker, localize(1470, "No matching editor symbols"));
                    }
                    else {
                        this.provideLabelPick(picker, localize(1471, "No editor symbols"));
                    }
                }
            }
            finally {
    ...
    async doGetSymbolPicks(symbolsPromise, query, options, token, model) {
        ...
        if (openSideBySideDirection) {
            buttons = [{
                    ...
                    tooltip: openSideBySideDirection === 'right' ? localize(1472, "Open to the Side") : localize(1473, "Open to the Bottom")
                }];
        }
        ...
        if (filterBySymbolKind) {
            ...
            symbolPicks = [
                { label: localize(1474, "symbols ({0})", filteredSymbolPicks.length), type: 'separator' },
...
// #region NLS Helpers
const FALLBACK_NLS_SYMBOL_KIND = localize(1475, "properties ({0})");
const NLS_SYMBOL_KIND_CACHE = {
    [5 /* SymbolKind.Method */]: localize(1476, "methods ({0})"),
    [11 /* SymbolKind.Function */]: localize(1477, "functions ({0})"),
    [8 /* SymbolKind.Constructor */]: localize(1478, "constructors ({0})"),
    [12 /* SymbolKind.Variable */]: localize(1479, "variables ({0})"),
    [4 /* SymbolKind.Class */]: localize(1480, "classes ({0})"),
    [22 /* SymbolKind.Struct */]: localize(1481, "structs ({0})"),
    [23 /* SymbolKind.Event */]: localize(1482, "events ({0})"),
    [24 /* SymbolKind.Operator */]: localize(1483, "operators ({0})"),
    [10 /* SymbolKind.Interface */]: localize(1484, "interfaces ({0})"),
    [2 /* SymbolKind.Namespace */]: localize(1485, "namespaces ({0})"),
    [3 /* SymbolKind.Package */]: localize(1486, "packages ({0})"),
    [25 /* SymbolKind.TypeParameter */]: localize(1487, "type parameters ({0})"),
    [1 /* SymbolKind.Module */]: localize(1488, "modules ({0})"),
    [6 /* SymbolKind.Property */]: localize(1489, "properties ({0})"),
    [9 /* SymbolKind.Enum */]: localize(1490, "enumerations ({0})"),
    [21 /* SymbolKind.EnumMember */]: localize(1491, "enumeration members ({0})"),
    [14 /* SymbolKind.String */]: localize(1492, "strings ({0})"),
    [0 /* SymbolKind.File */]: localize(1493, "files ({0})"),
    [17 /* SymbolKind.Array */]: localize(1494, "arrays ({0})"),
    [15 /* SymbolKind.Number */]: localize(1495, "numbers ({0})"),
    [16 /* SymbolKind.Boolean */]: localize(1496, "booleans ({0})"),
    [18 /* SymbolKind.Object */]: localize(1497, "objects ({0})"),
    [19 /* SymbolKind.Key */]: localize(1498, "keys ({0})"),
    [7 /* SymbolKind.Field */]: localize(1499, "fields ({0})"),
    [13 /* SymbolKind.Constant */]: localize(1500, "constants ({0})")
};
//#endregion
