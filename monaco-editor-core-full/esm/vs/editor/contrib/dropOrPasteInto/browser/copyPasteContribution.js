...
registerEditorAction(class PasteAsAction extends EditorAction {
        ...
        oneOf: [
            ...
            },
            {
                ...
                properties: {
                    preferences: {
                        type: 'array',
                        description: nls.localize(1032, "List of preferred paste edit kind to try applying.\nThe first edit matching the preferences will be applied."),
                        items: { type: 'string' }
                    }
                },
            }
    ...
    constructor() {
        super({
            id: pasteAsCommandId,
            label: nls.localize2(1033, "Paste As..."),
...
registerEditorAction(class extends EditorAction {
    constructor() {
        super({
            ...
            label: nls.localize2(1034, "Paste as Text"),
            precondition: EditorContextKeys.writable,
            canTriggerInlineEdits: true,
        });
    }
