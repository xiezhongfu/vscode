...
export class DefaultTextPasteOrDropEditProvider extends SimplePasteAndDropProvider {
    ...
    async getEdit(dataTransfer, _token) {
        ...
        return {
            ...
            title: localize(1044, "Insert Plain Text"),
            insertText,
            kind: this.kind,
        };
    }
    ...
    async getEdit(dataTransfer, token) {
        ...
        if (uriCount > 0) {
            ...
            label = entries.length > 1
                ? localize(1045, "Insert Uris")
                : localize(1046, "Insert Uri");
        }
        else {
            // All the paths are file paths
            label = entries.length > 1
                ? localize(1047, "Insert Paths")
                : localize(1048, "Insert Path");
        }
        return {
    ...
    async getEdit(dataTransfer, token) {
        ...
        return {
            ...
            title: entries.length > 1
                ? localize(1049, "Insert Relative Paths")
                : localize(1050, "Insert Relative Path"),
            kind: this.kind,
        };
    }
};
    ...
    async provideDocumentPasteEdits(_model, _ranges, dataTransfer, context, token) {
        ...
        return {
            ...
            edits: [{
                    ...
                    title: localize(1051, 'Insert HTML'),
                    kind: this.kind,
                }],
        };
    }
