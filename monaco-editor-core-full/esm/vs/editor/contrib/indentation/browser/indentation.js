...
export class IndentationToSpacesAction extends EditorAction {
    ...
    constructor() {
        super({
            ...
            label: nls.localize2(1271, "Convert Indentation to Spaces"),
            precondition: EditorContextKeys.writable,
            metadata: {
                description: nls.localize2(1272, "Convert the tab indentation to spaces."),
            }
        });
    }
    run(accessor, editor) {
...
export class IndentationToTabsAction extends EditorAction {
    ...
    constructor() {
        super({
            ...
            label: nls.localize2(1273, "Convert Indentation to Tabs"),
            precondition: EditorContextKeys.writable,
            metadata: {
                description: nls.localize2(1274, "Convert the spaces indentation to tabs."),
            }
        });
    }
    run(accessor, editor) {
    ...
    run(accessor, editor) {
        ...
        const picks = [1, 2, 3, 4, 5, 6, 7, 8].map(n => ({
            ...
            description: (n === creationOpts.tabSize && n === modelOpts.tabSize
                ? nls.localize(1267, "Configured Tab Size")
                : n === creationOpts.tabSize
                    ? nls.localize(1268, "Default Tab Size")
                    : n === modelOpts.tabSize
                        ? nls.localize(1269, "Current Tab Size")
                        : undefined)
        }));
        // auto focus the tabSize set for the current editor
        const autoFocusIndex = Math.min(model.getOptions().tabSize - 1, 7);
        setTimeout(() => {
            quickInputService.pick(picks, { placeHolder: nls.localize(1270, "Select Tab Size for Current File"), activeItem: picks[autoFocusIndex] }).then(pick => {
                if (pick) {
...
export class IndentUsingTabs extends ChangeIndentationSizeAction {
    ...
    constructor() {
        super(false, false, {
            ...
            label: nls.localize2(1275, "Indent Using Tabs"),
            precondition: undefined,
            metadata: {
                description: nls.localize2(1276, "Use indentation with tabs."),
            }
        });
    }
}
export class IndentUsingSpaces extends ChangeIndentationSizeAction {
    ...
    constructor() {
        super(true, false, {
            ...
            label: nls.localize2(1277, "Indent Using Spaces"),
            precondition: undefined,
            metadata: {
                description: nls.localize2(1278, "Use indentation with spaces."),
            }
        });
    }
}
export class ChangeTabDisplaySize extends ChangeIndentationSizeAction {
    ...
    constructor() {
        super(true, true, {
            ...
            label: nls.localize2(1279, "Change Tab Display Size"),
            precondition: undefined,
            metadata: {
                description: nls.localize2(1280, "Change the space size equivalent of the tab."),
            }
        });
    }
}
export class DetectIndentation extends EditorAction {
    ...
    constructor() {
        super({
            ...
            label: nls.localize2(1281, "Detect Indentation from Content"),
            precondition: undefined,
            metadata: {
                description: nls.localize2(1282, "Detect the indentation from content."),
            }
        });
    }
    run(accessor, editor) {
...
export class ReindentLinesAction extends EditorAction {
    constructor() {
        super({
            ...
            label: nls.localize2(1283, "Reindent Lines"),
            precondition: EditorContextKeys.writable,
            metadata: {
                description: nls.localize2(1284, "Reindent the lines of the editor."),
            },
...
export class ReindentSelectedLinesAction extends EditorAction {
    constructor() {
        super({
            ...
            label: nls.localize2(1285, "Reindent Selected Lines"),
            precondition: EditorContextKeys.writable,
            metadata: {
                description: nls.localize2(1286, "Reindent the selected lines of the editor."),
            },
            canTriggerInlineEdits: true,
        });
    }
