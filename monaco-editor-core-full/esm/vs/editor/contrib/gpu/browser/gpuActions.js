...
class DebugEditorGpuRendererAction extends EditorAction {
    constructor() {
        super({
            ...
            label: localize2(1219, "Developer: Debug Editor GPU Renderer"),
    ...
    async run(accessor, editor) {
        ...
        const choice = await quickInputService.pick([
            {
                label: localize(1216, "Log Texture Atlas Stats"),
                id: 'logTextureAtlasStats',
            },
            {
                label: localize(1217, "Save Texture Atlas"),
                id: 'saveTextureAtlas',
            },
            {
                label: localize(1218, "Draw Glyph"),
                id: 'drawGlyph',
            },
        ], { canPickMany: false });
        if (!choice) {
