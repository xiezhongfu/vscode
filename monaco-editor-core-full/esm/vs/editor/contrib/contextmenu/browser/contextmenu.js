...
let ContextMenuController = class ContextMenuController {
    ...
    _showScrollbarContextMenu(anchor) {
        ...
        const actions = [];
        actions.push(createAction({
            label: nls.localize(1019, "Minimap"),
        ...
        actions.push(createAction({
            label: nls.localize(1020, "Render Characters"),
        ...
        actions.push(createEnumAction(nls.localize(1021, "Vertical size"), minimapOptions.enabled, 'editor.minimap.size', minimapOptions.size, [{
                label: nls.localize(1022, "Proportional"),
                value: 'proportional'
            }, {
                label: nls.localize(1023, "Fill"),
                value: 'fill'
            }, {
                label: nls.localize(1024, "Fit"),
                value: 'fit'
            }]));
        actions.push(createEnumAction(nls.localize(1025, "Slider"), minimapOptions.enabled, 'editor.minimap.showSlider', minimapOptions.showSlider, [{
                label: nls.localize(1026, "Mouse Over"),
                value: 'mouseover'
            }, {
                label: nls.localize(1027, "Always"),
                value: 'always'
            }]));
        const useShadowDOM = this._editor.getOption(144 /* EditorOption.useShadowDOM */) && !isIOS; // Do not use shadow dom on IOS #122035
        this._contextMenuIsBeingShownCount++;
...
class ShowContextMenu extends EditorAction {
    constructor() {
        super({
            ...
            label: nls.localize2(1028, "Show Editor Context Menu"),
