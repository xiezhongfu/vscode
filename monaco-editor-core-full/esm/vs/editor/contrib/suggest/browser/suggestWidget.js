 ...
 */
registerColor('editorSuggestWidget.background', editorWidgetBackground, nls.localize(1596, 'Background color of the suggest widget.'));
registerColor('editorSuggestWidget.border', editorWidgetBorder, nls.localize(1597, 'Border color of the suggest widget.'));
export const editorSuggestWidgetForeground = registerColor('editorSuggestWidget.foreground', editorForeground, nls.localize(1598, 'Foreground color of the suggest widget.'));
registerColor('editorSuggestWidget.selectedForeground', quickInputListFocusForeground, nls.localize(1599, 'Foreground color of the selected entry in the suggest widget.'));
registerColor('editorSuggestWidget.selectedIconForeground', quickInputListFocusIconForeground, nls.localize(1600, 'Icon foreground color of the selected entry in the suggest widget.'));
export const editorSuggestWidgetSelectedBackground = registerColor('editorSuggestWidget.selectedBackground', quickInputListFocusBackground, nls.localize(1601, 'Background color of the selected entry in the suggest widget.'));
registerColor('editorSuggestWidget.highlightForeground', listHighlightForeground, nls.localize(1602, 'Color of the match highlights in the suggest widget.'));
registerColor('editorSuggestWidget.focusHighlightForeground', listFocusHighlightForeground, nls.localize(1603, 'Color of the match highlights in the suggest widget when an item is focused.'));
registerColor('editorSuggestWidgetStatus.foreground', transparent(editorSuggestWidgetForeground, .5), nls.localize(1604, 'Foreground color of the suggest widget status.'));
...
let SuggestWidget = class SuggestWidget {
    ...
    static { this.LOADING_MESSAGE = nls.localize(1605, "Loading..."); }
    static { this.NO_SUGGESTIONS_MESSAGE = nls.localize(1606, "No suggestions."); }
    constructor(editor, _storageService, _contextKeyService, _themeService, instantiationService) {
        ...
        this._list = new List('SuggestWidget', this._listElement, {
            ...
            accessibilityProvider: {
                ...
                getWidgetAriaLabel: () => nls.localize(1607, "Suggest"),
                ...
                getAriaLabel: (item) => {
                    ...
                    if (typeof item.completion.label !== 'string') {
                        ...
                        if (detail && description) {
                            label = nls.localize(1608, '{0} {1}, {2}, {3}', label, detail, description, kindLabel);
                        }
                        else if (detail) {
                            label = nls.localize(1609, '{0} {1}, {2}', label, detail, kindLabel);
                        }
                        else if (description) {
                            label = nls.localize(1610, '{0}, {1}, {2}', label, description, kindLabel);
                        }
                    }
                    else {
                        label = nls.localize(1611, '{0}, {1}', label, kindLabel);
                    }
                    ...
                    return nls.localize(1612, "{0}, docs: {1}", label, docs);
                },
            }
        });
