...
let SuggestController = class SuggestController {
    ...
    _alertCompletionItem(item) {
        if (isNonEmptyArray(item.completion.additionalTextEdits)) {
            const msg = nls.localize(1586, "Accepting '{0}' made {1} additional edits", item.textLabel, item.completion.additionalTextEdits.length);
            alert(msg);
        }
    }
...
export class TriggerSuggestAction extends EditorAction {
    ...
    constructor() {
        super({
            ...
            label: nls.localize2(1594, "Trigger Suggest"),
...
registerEditorCommand(new SuggestCommand({
    ...
    menuOpts: [{
            ...
            title: nls.localize(1587, "Insert"),
            group: 'left',
            order: 1,
            when: SuggestContext.HasInsertAndReplaceRange.toNegated()
        }, {
            menuId: suggestWidgetStatusbarMenu,
            title: nls.localize(1588, "Insert"),
            group: 'left',
            order: 1,
            when: ContextKeyExpr.and(SuggestContext.HasInsertAndReplaceRange, SuggestContext.InsertMode.isEqualTo('insert'))
        }, {
            menuId: suggestWidgetStatusbarMenu,
            title: nls.localize(1589, "Replace"),
            group: 'left',
            order: 1,
...
registerEditorCommand(new SuggestCommand({
    ...
    menuOpts: [{
            ...
            order: 2,
            when: ContextKeyExpr.and(SuggestContext.HasInsertAndReplaceRange, SuggestContext.InsertMode.isEqualTo('insert')),
            title: nls.localize(1590, "Replace")
        }, {
            menuId: suggestWidgetStatusbarMenu,
            group: 'left',
            order: 2,
            when: ContextKeyExpr.and(SuggestContext.HasInsertAndReplaceRange, SuggestContext.InsertMode.isEqualTo('replace')),
            title: nls.localize(1591, "Insert")
        }]
}));
...
registerEditorCommand(new SuggestCommand({
    ...
    menuOpts: [{
            ...
            title: nls.localize(1592, "Show Less")
        }, {
            menuId: suggestWidgetStatusbarMenu,
            group: 'right',
            order: 1,
            when: ContextKeyExpr.and(SuggestContext.DetailsVisible.toNegated(), SuggestContext.CanResolve),
            title: nls.localize(1593, "Show More")
        }]
}));
registerEditorCommand(new SuggestCommand({
...
registerEditorAction(class extends EditorAction {
    constructor() {
        super({
            ...
            label: nls.localize2(1595, "Reset Suggest Widget Size"),
