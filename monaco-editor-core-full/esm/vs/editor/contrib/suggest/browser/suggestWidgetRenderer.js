...
const suggestMoreInfoIcon = registerIcon('suggest-more-info', Codicon.chevronRight, nls.localize(1615, 'Icon for more information in the suggest widget.'));
...
let ItemRenderer = class ItemRenderer {
    ...
    renderTemplate(container) {
        ...
        readMore.title = nls.localize(1616, "Read More");
        const configureFont = () => {
