    ...
    async _checkForUnusualLineTerminators() {
        ...
        try {
            ...
            result = await this._dialogService.confirm({
                title: nls.localize(1681, "Unusual Line Terminators"),
                message: nls.localize(1682, "Detected unusual line terminators"),
                detail: nls.localize(1683, "The file '{0}' contains one or more unusual line terminator characters, like Line Separator (LS) or Paragraph Separator (PS).\n\nIt is recommended to remove them from the file. This can be configured via `editor.unusualLineTerminators`.", basename(model.uri)),
                primaryButton: nls.localize(1684, "&&Remove Unusual Line Terminators"),
                cancelButton: nls.localize(1685, "Ignore")
            });
        }
        finally {
            this._isPresentingDialog = false;
