...
class CopyLinesUpAction extends AbstractCopyLinesAction {
    constructor() {
        super(false, {
            ...
            label: nls.localize2(1372, "Copy Line Up"),
            ...
            menuOpts: {
                ...
                group: '2_line',
                title: nls.localize(1367, "&&Copy Line Up"),
                order: 1
            },
...
class CopyLinesDownAction extends AbstractCopyLinesAction {
    constructor() {
        super(true, {
            ...
            label: nls.localize2(1373, "Copy Line Down"),
            precondition: EditorContextKeys.writable,
            kbOpts: {
                kbExpr: EditorContextKeys.editorTextFocus,
            ...
            menuOpts: {
                menuId: MenuId.MenubarSelectionMenu,
                group: '2_line',
                title: nls.localize(1368, "Co&&py Line Down"),
                order: 2
            },
            canTriggerInlineEdits: true,
        });
...
export class DuplicateSelectionAction extends EditorAction {
    constructor() {
        super({
            ...
            label: nls.localize2(1374, "Duplicate Selection"),
            precondition: EditorContextKeys.writable,
            menuOpts: {
                menuId: MenuId.MenubarSelectionMenu,
                group: '2_line',
                title: nls.localize(1369, "&&Duplicate Selection"),
                order: 5
            },
            canTriggerInlineEdits: true,
        });
...
class MoveLinesUpAction extends AbstractMoveLinesAction {
    constructor() {
        super(false, {
            ...
            label: nls.localize2(1375, "Move Line Up"),
            precondition: EditorContextKeys.writable,
            kbOpts: {
                kbExpr: EditorContextKeys.editorTextFocus,
            ...
            menuOpts: {
                menuId: MenuId.MenubarSelectionMenu,
                group: '2_line',
                title: nls.localize(1370, "Mo&&ve Line Up"),
                order: 3
            },
            canTriggerInlineEdits: true,
        });
...
class MoveLinesDownAction extends AbstractMoveLinesAction {
    constructor() {
        super(true, {
            ...
            label: nls.localize2(1376, "Move Line Down"),
            precondition: EditorContextKeys.writable,
            kbOpts: {
                kbExpr: EditorContextKeys.editorTextFocus,
            ...
            menuOpts: {
                menuId: MenuId.MenubarSelectionMenu,
                group: '2_line',
                title: nls.localize(1371, "Move &&Line Down"),
                order: 4
            },
            canTriggerInlineEdits: true,
        });
...
export class SortLinesAscendingAction extends AbstractSortLinesAction {
    constructor() {
        super(false, {
            ...
            label: nls.localize2(1377, "Sort Lines Ascending"),
            precondition: EditorContextKeys.writable,
            canTriggerInlineEdits: true,
        });
    }
...
export class SortLinesDescendingAction extends AbstractSortLinesAction {
    constructor() {
        super(true, {
            ...
            label: nls.localize2(1378, "Sort Lines Descending"),
            precondition: EditorContextKeys.writable,
            canTriggerInlineEdits: true,
        });
    }
...
export class DeleteDuplicateLinesAction extends EditorAction {
    constructor() {
        super({
            ...
            label: nls.localize2(1379, "Delete Duplicate Lines"),
            precondition: EditorContextKeys.writable,
            canTriggerInlineEdits: true,
        });
    }
...
export class ReverseLinesAction extends EditorAction {
    constructor() {
        super({
            ...
            label: nls.localize2(1380, "Reverse lines"),
            precondition: EditorContextKeys.writable,
            canTriggerInlineEdits: true
        });
    }
...
export class TrimTrailingWhitespaceAction extends EditorAction {
    ...
    constructor() {
        super({
            ...
            label: nls.localize2(1381, "Trim Trailing Whitespace"),
            precondition: EditorContextKeys.writable,
            kbOpts: {
                kbExpr: EditorContextKeys.editorTextFocus,
...
export class DeleteLinesAction extends EditorAction {
    constructor() {
        super({
            ...
            label: nls.localize2(1382, "Delete Line"),
            precondition: EditorContextKeys.writable,
            kbOpts: {
...
export class IndentLinesAction extends EditorAction {
    constructor() {
        super({
            ...
            label: nls.localize2(1383, "Indent Line"),
            precondition: EditorContextKeys.writable,
            kbOpts: {
                kbExpr: EditorContextKeys.editorTextFocus,
...
class OutdentLinesAction extends EditorAction {
    constructor() {
        super({
            ...
            label: nls.localize2(1384, "Outdent Line"),
            precondition: EditorContextKeys.writable,
            kbOpts: {
                kbExpr: EditorContextKeys.editorTextFocus,
...
export class InsertLineBeforeAction extends EditorAction {
    ...
    constructor() {
        super({
            ...
            label: nls.localize2(1385, "Insert Line Above"),
            precondition: EditorContextKeys.writable,
            kbOpts: {
                kbExpr: EditorContextKeys.editorTextFocus,
...
export class InsertLineAfterAction extends EditorAction {
    ...
    constructor() {
        super({
            ...
            label: nls.localize2(1386, "Insert Line Below"),
            precondition: EditorContextKeys.writable,
            kbOpts: {
                kbExpr: EditorContextKeys.editorTextFocus,
...
export class DeleteAllLeftAction extends AbstractDeleteAllToBoundaryAction {
    constructor() {
        super({
            id: 'deleteAllLeft',
            label: nls.localize2(1387, "Delete All Left"),
            precondition: EditorContextKeys.writable,
            kbOpts: {
                kbExpr: EditorContextKeys.textInputFocus,
                primary: 0,
...
export class DeleteAllRightAction extends AbstractDeleteAllToBoundaryAction {
    constructor() {
        super({
            id: 'deleteAllRight',
            label: nls.localize2(1388, "Delete All Right"),
            precondition: EditorContextKeys.writable,
            kbOpts: {
                kbExpr: EditorContextKeys.textInputFocus,
                primary: 0,
...
export class JoinLinesAction extends EditorAction {
    constructor() {
        super({
            ...
            label: nls.localize2(1389, "Join Lines"),
            precondition: EditorContextKeys.writable,
            kbOpts: {
                kbExpr: EditorContextKeys.editorTextFocus,
                primary: 0,
...
export class TransposeAction extends EditorAction {
    constructor() {
        super({
            ...
            label: nls.localize2(1390, "Transpose Characters around the Cursor"),
            precondition: EditorContextKeys.writable,
            canTriggerInlineEdits: true,
        });
    }
...
export class UpperCaseAction extends AbstractCaseAction {
    constructor() {
        super({
            ...
            label: nls.localize2(1391, "Transform to Uppercase"),
            precondition: EditorContextKeys.writable,
            canTriggerInlineEdits: true,
        });
    }
...
export class LowerCaseAction extends AbstractCaseAction {
    constructor() {
        super({
            ...
            label: nls.localize2(1392, "Transform to Lowercase"),
            precondition: EditorContextKeys.writable,
            canTriggerInlineEdits: true
        });
    }
...
export class TitleCaseAction extends AbstractCaseAction {
    ...
    constructor() {
        super({
            ...
            label: nls.localize2(1393, "Transform to Title Case"),
            precondition: EditorContextKeys.writable,
            canTriggerInlineEdits: true
        });
    }
...
export class SnakeCaseAction extends AbstractCaseAction {
    ...
    constructor() {
        super({
            ...
            label: nls.localize2(1394, "Transform to Snake Case"),
            precondition: EditorContextKeys.writable,
            canTriggerInlineEdits: true,
        });
    }
...
export class CamelCaseAction extends AbstractCaseAction {
    ...
    constructor() {
        super({
            ...
            label: nls.localize2(1395, "Transform to Camel Case"),
            precondition: EditorContextKeys.writable,
            canTriggerInlineEdits: true
        });
    }
...
export class PascalCaseAction extends AbstractCaseAction {
    ...
    constructor() {
        super({
            ...
            label: nls.localize2(1396, "Transform to Pascal Case"),
            precondition: EditorContextKeys.writable,
            canTriggerInlineEdits: true,
        });
    }
...
export class KebabCaseAction extends AbstractCaseAction {
    ...
    constructor() {
        super({
            ...
            label: nls.localize2(1397, 'Transform to Kebab Case'),
            precondition: EditorContextKeys.writable,
            canTriggerInlineEdits: true,
        });
    }
