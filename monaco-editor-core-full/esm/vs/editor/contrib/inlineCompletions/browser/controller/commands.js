...
export class ShowNextInlineSuggestionAction extends EditorAction {
    ...
    constructor() {
        super({
            ...
            label: nls.localize2(1306, "Show Next Inline Suggestion"),
...
export class ShowPreviousInlineSuggestionAction extends EditorAction {
    ...
    constructor() {
        super({
            ...
            label: nls.localize2(1307, "Show Previous Inline Suggestion"),
            precondition: ContextKeyExpr.and(EditorContextKeys.writable, InlineCompletionContextKeys.inlineSuggestionVisible),
            kbOpts: {
                weight: 100,
...
export class TriggerInlineSuggestionAction extends EditorAction {
    constructor() {
        super({
            ...
            label: nls.localize2(1308, "Trigger Inline Suggestion"),
            precondition: EditorContextKeys.writable,
            metadata: {
                description: nls.localize(1295, "Triggers an inline suggestion in the editor."),
                args: [{
                        name: 'args',
                        description: nls.localize(1296, "Options for triggering inline suggestions."),
                        isOptional: true,
        ...
        if (validatedArgs?.showNoResultNotification) {
            if (!controller?.model.get()?.state.get()) {
                notificationService.notify({
                    ...
                    message: nls.localize(1297, "No inline suggestion is available.")
                });
            }
        }
    }
...
export class AcceptNextWordOfInlineCompletion extends EditorAction {
    constructor() {
        super({
            ...
            label: nls.localize2(1309, "Accept Next Word Of Inline Suggestion"),
            precondition: ContextKeyExpr.and(EditorContextKeys.writable, InlineCompletionContextKeys.inlineSuggestionVisible),
            kbOpts: {
            ...
            menuOpts: [{
                    ...
                    title: nls.localize(1298, 'Accept Word'),
                    group: 'primary',
                    order: 2,
                }],
        });
...
export class AcceptNextLineOfInlineCompletion extends EditorAction {
    constructor() {
        super({
            ...
            label: nls.localize2(1310, "Accept Next Line Of Inline Suggestion"),
            precondition: ContextKeyExpr.and(EditorContextKeys.writable, InlineCompletionContextKeys.inlineSuggestionVisible),
            kbOpts: {
                weight: 100 /* KeybindingWeight.EditorContrib */ + 1,
            },
            menuOpts: [{
                    menuId: MenuId.InlineSuggestionToolbar,
                    title: nls.localize(1299, 'Accept Line'),
                    group: 'secondary',
                    order: 2,
                }],
        });
...
export class AcceptInlineCompletion extends EditorAction {
    constructor() {
        super({
            ...
            label: nls.localize2(1311, "Accept Inline Suggestion"),
            ...
            menuOpts: [{
                    menuId: MenuId.InlineSuggestionToolbar,
                    title: nls.localize(1300, "Accept"),
                    group: 'primary',
                    order: 2,
                }, {
                    menuId: MenuId.InlineEditsActions,
                    title: nls.localize(1301, "Accept"),
                    group: 'primary',
                    order: 2,
                }],
            kbOpts: [
...
export class JumpToNextInlineEdit extends EditorAction {
    constructor() {
        super({
            ...
            label: nls.localize2(1312, "Jump to next inline edit"),
            precondition: InlineCompletionContextKeys.inlineEditVisible,
            menuOpts: [{
                    menuId: MenuId.InlineEditsActions,
                    title: nls.localize(1302, "Jump"),
                    group: 'primary',
                    order: 1,
...
export class HideInlineCompletion extends EditorAction {
    ...
    constructor() {
        super({
            ...
            label: nls.localize2(1313, "Hide Inline Suggestion"),
            precondition: ContextKeyExpr.or(InlineCompletionContextKeys.inlineSuggestionVisible, InlineCompletionContextKeys.inlineEditVisible),
            kbOpts: {
            ...
            menuOpts: [{
                    menuId: MenuId.InlineEditsActions,
                    title: nls.localize(1303, "Reject"),
                    group: 'primary',
                    order: 3,
                }]
        });
...
export class ToggleInlineCompletionShowCollapsed extends EditorAction {
    ...
    constructor() {
        super({
            ...
            label: nls.localize2(1314, "Toggle Inline Suggestions Show Collapsed"),
...
export class ToggleAlwaysShowInlineSuggestionToolbar extends Action2 {
    ...
    constructor() {
        super({
            ...
            title: nls.localize(1304, "Always Show Toolbar"),
            f1: false,
...
export class DevExtractReproSample extends EditorAction {
    constructor() {
        super({
            ...
            label: nls.localize(1305, "Developer: Extract Inline Suggest State"),
