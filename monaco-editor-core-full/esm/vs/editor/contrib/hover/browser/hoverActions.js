...
export class ShowOrFocusHoverAction extends EditorAction {
    constructor() {
        super({
            ...
            label: nls.localize2(1230, "Show or Focus Hover"),
            ...
            metadata: {
                description: nls.localize2(1231, 'Show or focus the editor hover which shows documentation, references, and other content for a symbol at the current cursor position.'),
                args: [{
                        name: 'args',
                        schema: {
                            type: 'object',
                            properties: {
                                'focus': {
                                    ...
                                    enumDescriptions: [
                                        nls.localize(1227, 'The hover will not automatically take focus.'),
                                        nls.localize(1228, 'The hover will take focus only if it is already visible.'),
                                        nls.localize(1229, 'The hover will automatically take focus when it appears.'),
                                    ],
...
export class ShowDefinitionPreviewHoverAction extends EditorAction {
    constructor() {
        super({
            ...
            label: nls.localize2(1232, "Show Definition Preview Hover"),
            ...
            precondition: undefined,
            metadata: {
                description: nls.localize2(1233, 'Show the definition preview hover in the editor.'),
            },
        });
    }
    run(accessor, editor) {
...
export class HideContentHoverAction extends EditorAction {
    constructor() {
        super({
            ...
            label: nls.localize2(1234, "Hide Hover"),
...
export class ScrollUpHoverAction extends EditorAction {
    constructor() {
        super({
            ...
            label: nls.localize2(1235, "Scroll Up Hover"),
            ...
            metadata: {
                description: nls.localize2(1236, 'Scroll up the editor hover.')
            },
        });
    }
    run(accessor, editor) {
...
export class ScrollDownHoverAction extends EditorAction {
    constructor() {
        super({
            ...
            label: nls.localize2(1237, "Scroll Down Hover"),
            ...
            metadata: {
                description: nls.localize2(1238, 'Scroll down the editor hover.'),
            },
        });
    }
    run(accessor, editor) {
...
export class ScrollLeftHoverAction extends EditorAction {
    constructor() {
        super({
            ...
            label: nls.localize2(1239, "Scroll Left Hover"),
            ...
            metadata: {
                description: nls.localize2(1240, 'Scroll left the editor hover.'),
            },
        });
    }
    run(accessor, editor) {
...
export class ScrollRightHoverAction extends EditorAction {
    constructor() {
        super({
            ...
            label: nls.localize2(1241, "Scroll Right Hover"),
            ...
            metadata: {
                description: nls.localize2(1242, 'Scroll right the editor hover.')
            },
        });
    }
    run(accessor, editor) {
...
export class PageUpHoverAction extends EditorAction {
    constructor() {
        super({
            ...
            label: nls.localize2(1243, "Page Up Hover"),
            ...
            metadata: {
                description: nls.localize2(1244, 'Page up the editor hover.'),
            },
        });
    }
    run(accessor, editor) {
...
export class PageDownHoverAction extends EditorAction {
    constructor() {
        super({
            ...
            label: nls.localize2(1245, "Page Down Hover"),
            ...
            metadata: {
                description: nls.localize2(1246, 'Page down the editor hover.'),
            },
        });
    }
    run(accessor, editor) {
...
export class GoToTopHoverAction extends EditorAction {
    constructor() {
        super({
            ...
            label: nls.localize2(1247, "Go To Top Hover"),
            ...
            metadata: {
                description: nls.localize2(1248, 'Go to the top of the editor hover.'),
            },
        });
    }
    run(accessor, editor) {
...
export class GoToBottomHoverAction extends EditorAction {
    constructor() {
        super({
            ...
            label: nls.localize2(1249, "Go To Bottom Hover"),
            ...
            metadata: {
                description: nls.localize2(1250, 'Go to the bottom of the editor hover.')
            },
        });
    }
    run(accessor, editor) {
