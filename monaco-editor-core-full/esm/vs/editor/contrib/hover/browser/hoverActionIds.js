...
export const INCREASE_HOVER_VERBOSITY_ACTION_LABEL = nls.localize(1225, "Increase Hover Verbosity Level");
...
export const DECREASE_HOVER_VERBOSITY_ACTION_LABEL = nls.localize(1226, "Decrease Hover Verbosity Level");
