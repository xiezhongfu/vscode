...
let MarkerHoverParticipant = class MarkerHoverParticipant {
    ...
    _renderMarkerStatusbar(context, markerHover) {
        ...
        if (markerHover.marker.severity === MarkerSeverity.Error || markerHover.marker.severity === MarkerSeverity.Warning || markerHover.marker.severity === MarkerSeverity.Info) {
            ...
            if (markerController) {
                context.statusBar.addAction({
                    label: nls.localize(1262, "View Problem"),
        ...
        if (!this._editor.getOption(104 /* EditorOption.readOnly */)) {
            ...
            if (this.recentMarkerCodeActionsInfo) {
                if (IMarkerData.makeKey(this.recentMarkerCodeActionsInfo.marker) === IMarkerData.makeKey(markerHover.marker)) {
                    if (!this.recentMarkerCodeActionsInfo.hasCodeActions) {
                        quickfixPlaceholderElement.textContent = nls.localize(1263, "No quick fixes available");
                    }
                }
                else {
                    this.recentMarkerCodeActionsInfo = undefined;
            ...
            const updatePlaceholderDisposable = this.recentMarkerCodeActionsInfo && !this.recentMarkerCodeActionsInfo.hasCodeActions ? Disposable.None : disposableTimeout(() => quickfixPlaceholderElement.textContent = nls.localize(1264, "Checking for quick fixes..."), 200, disposables);
            ...
            codeActionsPromise.then(actions => {
                ...
                context.statusBar.addAction({
                    label: nls.localize(1266, "Quick Fix..."),
