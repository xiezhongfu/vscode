...
const $ = dom.$;
const parameterHintsNextIcon = registerIcon('parameter-hints-next', Codicon.chevronDown, nls.localize(1435, 'Icon for show next parameter hint.'));
const parameterHintsPreviousIcon = registerIcon('parameter-hints-previous', Codicon.chevronUp, nls.localize(1436, 'Icon for show previous parameter hint.'));
    ...
    render(hints) {
        ...
        if (activeParameter) {
            ...
            if (this.announcedLabel !== labelToAnnounce) {
                aria.alert(nls.localize(1437, "{0}, hint", labelToAnnounce));
...
registerColor('editorHoverWidget.highlightForeground', listHighlightForeground, nls.localize(1438, 'Foreground color of the active item in the parameter hint.'));
