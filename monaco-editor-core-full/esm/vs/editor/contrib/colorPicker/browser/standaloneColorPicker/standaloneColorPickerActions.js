...
export class ShowOrFocusStandaloneColorPicker extends EditorAction2 {
    constructor() {
        super({
            ...
            title: {
                ...localize2(1007, "Show or Focus Standalone Color Picker"),
                mnemonicTitle: localize(1006, "&&Show or Focus Standalone Color Picker"),
            },
            ...
            metadata: {
                description: localize2(1008, "Show or focus a standalone color picker which uses the default color provider. It displays hex/rgb/hsl colors."),
            }
        });
    }
...
export class HideStandaloneColorPicker extends EditorAction {
    constructor() {
        super({
            ...
            label: localize2(1009, "Hide the Color Picker"),
            ...
            metadata: {
                description: localize2(1010, "Hide the standalone color picker."),
            }
        });
    }
...
export class InsertColorWithStandaloneColorPicker extends EditorAction {
    constructor() {
        super({
            ...
            label: localize2(1011, "Insert Color with Standalone Color Picker"),
            ...
            metadata: {
                description: localize2(1012, "Insert hex/rgb/hsl colors with the focused standalone color picker."),
            }
        });
    }
    run(_accessor, editor) {
