...
export class CloseButton extends Disposable {
    constructor(container) {
        ...
        const closeButton = dom.append(innerDiv, $('.button' + ThemeIcon.asCSSSelector(registerIcon('color-picker-close', Codicon.close, localize(1003, 'Icon to close the color picker')))));
