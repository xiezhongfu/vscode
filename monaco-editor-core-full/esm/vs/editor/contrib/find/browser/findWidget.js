...
const findCollapsedIcon = registerIcon('find-collapsed', Codicon.chevronRight, nls.localize(1074, 'Icon to indicate that the editor find widget is collapsed.'));
const findExpandedIcon = registerIcon('find-expanded', Codicon.chevronDown, nls.localize(1075, 'Icon to indicate that the editor find widget is expanded.'));
export const findSelectionIcon = registerIcon('find-selection', Codicon.selection, nls.localize(1076, 'Icon for \'Find in Selection\' in the editor find widget.'));
export const findReplaceIcon = registerIcon('find-replace', Codicon.replace, nls.localize(1077, 'Icon for \'Replace\' in the editor find widget.'));
export const findReplaceAllIcon = registerIcon('find-replace-all', Codicon.replaceAll, nls.localize(1078, 'Icon for \'Replace All\' in the editor find widget.'));
export const findPreviousMatchIcon = registerIcon('find-previous-match', Codicon.arrowUp, nls.localize(1079, 'Icon for \'Find Previous\' in the editor find widget.'));
export const findNextMatchIcon = registerIcon('find-next-match', Codicon.arrowDown, nls.localize(1080, 'Icon for \'Find Next\' in the editor find widget.'));
const NLS_FIND_DIALOG_LABEL = nls.localize(1081, "Find / Replace");
const NLS_FIND_INPUT_LABEL = nls.localize(1082, "Find");
const NLS_FIND_INPUT_PLACEHOLDER = nls.localize(1083, "Find");
const NLS_PREVIOUS_MATCH_BTN_LABEL = nls.localize(1084, "Previous Match");
const NLS_NEXT_MATCH_BTN_LABEL = nls.localize(1085, "Next Match");
const NLS_TOGGLE_SELECTION_FIND_TITLE = nls.localize(1086, "Find in Selection");
const NLS_CLOSE_BTN_LABEL = nls.localize(1087, "Close");
const NLS_REPLACE_INPUT_LABEL = nls.localize(1088, "Replace");
const NLS_REPLACE_INPUT_PLACEHOLDER = nls.localize(1089, "Replace");
const NLS_REPLACE_BTN_LABEL = nls.localize(1090, "Replace");
const NLS_REPLACE_ALL_BTN_LABEL = nls.localize(1091, "Replace All");
const NLS_TOGGLE_REPLACE_MODE_BTN_LABEL = nls.localize(1092, "Toggle Replace");
const NLS_MATCHES_COUNT_LIMIT_TITLE = nls.localize(1093, "Only the first {0} results are highlighted, but all find operations work on the entire text.", MATCHES_LIMIT);
export const NLS_MATCHES_LOCATION = nls.localize(1094, "{0} of {1}");
export const NLS_NO_RESULTS = nls.localize(1095, "No results");
...
export class FindWidget extends Widget {
    ...
    _getAriaLabel(label, currentMatch, searchString) {
        if (label === NLS_NO_RESULTS) {
            return searchString === ''
                ? nls.localize(1096, "{0} found", label)
                : nls.localize(1097, "{0} found for '{1}'", label, searchString);
        }
        if (currentMatch) {
            const ariaLabel = nls.localize(1098, "{0} found for '{1}', at {2}", label, searchString, currentMatch.startLineNumber + ':' + currentMatch.startColumn);
        ...
        return nls.localize(1099, "{0} found for '{1}'", label, searchString);
    }
    /**
