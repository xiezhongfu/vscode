...
function announceCursorChange(previousCursorState, cursorState) {
    ...
    if (cursorDiff.length >= 1) {
        ...
        const msg = cursorDiff.length === 1 ? nls.localize(1411, "Cursor added: {0}", cursorPositions) : nls.localize(1412, "Cursors added: {0}", cursorPositions);
        status(msg);
    }
}
export class InsertCursorAbove extends EditorAction {
    constructor() {
        super({
            ...
            label: nls.localize2(1421, "Add Cursor Above"),
            ...
            menuOpts: {
                ...
                group: '3_multi',
                title: nls.localize(1413, "&&Add Cursor Above"),
                order: 2
            }
        });
    }
...
export class InsertCursorBelow extends EditorAction {
    constructor() {
        super({
            ...
            label: nls.localize2(1422, "Add Cursor Below"),
            precondition: undefined,
            kbOpts: {
                kbExpr: EditorContextKeys.editorTextFocus,
            ...
            menuOpts: {
                menuId: MenuId.MenubarSelectionMenu,
                group: '3_multi',
                title: nls.localize(1414, "A&&dd Cursor Below"),
                order: 3
            }
        });
    }
...
class InsertCursorAtEndOfEachLineSelected extends EditorAction {
    constructor() {
        super({
            ...
            label: nls.localize2(1423, "Add Cursors to Line Ends"),
            precondition: undefined,
            kbOpts: {
                kbExpr: EditorContextKeys.editorTextFocus,
            ...
            menuOpts: {
                menuId: MenuId.MenubarSelectionMenu,
                group: '3_multi',
                title: nls.localize(1415, "Add C&&ursors to Line Ends"),
                order: 4
            }
        });
    }
...
class InsertCursorAtEndOfLineSelected extends EditorAction {
    constructor() {
        super({
            ...
            label: nls.localize2(1424, "Add Cursors to Bottom"),
            precondition: undefined
        });
    }
    run(accessor, editor) {
...
class InsertCursorAtTopOfLineSelected extends EditorAction {
    constructor() {
        super({
            ...
            label: nls.localize2(1425, "Add Cursors to Top"),
            precondition: undefined
        });
    }
    run(accessor, editor) {
...
export class AddSelectionToNextFindMatchAction extends MultiCursorSelectionControllerAction {
    constructor() {
        super({
            ...
            label: nls.localize2(1426, "Add Selection to Next Find Match"),
            precondition: undefined,
            kbOpts: {
            ...
            menuOpts: {
                menuId: MenuId.MenubarSelectionMenu,
                group: '3_multi',
                title: nls.localize(1416, "Add &&Next Occurrence"),
                order: 5
            }
        });
    }
...
export class AddSelectionToPreviousFindMatchAction extends MultiCursorSelectionControllerAction {
    constructor() {
        super({
            ...
            label: nls.localize2(1427, "Add Selection to Previous Find Match"),
            precondition: undefined,
            menuOpts: {
                menuId: MenuId.MenubarSelectionMenu,
                group: '3_multi',
                title: nls.localize(1417, "Add P&&revious Occurrence"),
                order: 6
            }
        });
    }
...
export class MoveSelectionToNextFindMatchAction extends MultiCursorSelectionControllerAction {
    constructor() {
        super({
            ...
            label: nls.localize2(1428, "Move Last Selection to Next Find Match"),
            precondition: undefined,
            kbOpts: {
                kbExpr: EditorContextKeys.focus,
...
export class MoveSelectionToPreviousFindMatchAction extends MultiCursorSelectionControllerAction {
    constructor() {
        super({
            ...
            label: nls.localize2(1429, "Move Last Selection to Previous Find Match"),
            precondition: undefined
        });
    }
    _run(multiCursorController, findController) {
...
export class SelectHighlightsAction extends MultiCursorSelectionControllerAction {
    constructor() {
        super({
            ...
            label: nls.localize2(1430, "Select All Occurrences of Find Match"),
            precondition: undefined,
            kbOpts: {
                kbExpr: EditorContextKeys.focus,
            ...
            menuOpts: {
                menuId: MenuId.MenubarSelectionMenu,
                group: '3_multi',
                title: nls.localize(1418, "Select All &&Occurrences"),
                order: 7
            }
        });
    }
...
export class CompatChangeAll extends MultiCursorSelectionControllerAction {
    constructor() {
        super({
            ...
            label: nls.localize2(1431, "Change All Occurrences"),
...
export class FocusNextCursor extends EditorAction {
    constructor() {
        super({
            ...
            label: nls.localize2(1432, "Focus Next Cursor"),
            metadata: {
                description: nls.localize(1419, "Focuses the next cursor"),
                args: [],
            },
            precondition: undefined
        });
...
export class FocusPreviousCursor extends EditorAction {
    constructor() {
        super({
            ...
            label: nls.localize2(1433, "Focus Previous Cursor"),
            metadata: {
                description: nls.localize(1420, "Focuses the previous cursor"),
                args: [],
            },
            precondition: undefined
        });
