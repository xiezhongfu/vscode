        ...
        if (messageController && this.editor.hasModel()) {
            ...
            if (!message) {
                if (this.editor.isSimpleWidget) {
                    message = new MarkdownString(nls.localize(1501, "Cannot edit in read-only input"));
                }
                else {
                    message = new MarkdownString(nls.localize(1502, "Cannot edit in read-only editor"));
                }
            }
