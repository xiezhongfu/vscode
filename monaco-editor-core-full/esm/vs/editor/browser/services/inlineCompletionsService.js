...
const InlineCompletionsSnoozing = new RawContextKey('inlineCompletions.snoozed', false, localize(160, "Whether inline completions are currently snoozed"));
...
export class SnoozeInlineCompletion extends Action2 {
    ...
    async getDurationFromUser(quickInputService, storageService) {
        ...
        const picked = await quickInputService.pick(items, {
            placeHolder: localize(161, "Select snooze duration for Inline Suggestions"),
...
export class CancelSnoozeInlineCompletion extends Action2 {
    ...
    constructor() {
        super({
            ...
            title: localize2(163, "Cancel Snooze Inline Suggestions"),
