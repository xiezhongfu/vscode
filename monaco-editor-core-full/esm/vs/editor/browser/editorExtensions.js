...
export const UndoCommand = registerCommand(new MultiCommand({
    ...
    menuOpts: [{
            ...
            group: '1_do',
            title: nls.localize(150, "&&Undo"),
            order: 1
        }, {
            menuId: MenuId.CommandPalette,
            group: '',
            title: nls.localize(151, "Undo"),
            order: 1
        }, {
            menuId: MenuId.SimpleEditorContext,
            group: '1_do',
            title: nls.localize(152, "Undo"),
            order: 1
        }]
}));
...
export const RedoCommand = registerCommand(new MultiCommand({
    ...
    menuOpts: [{
            menuId: MenuId.MenubarEditMenu,
            group: '1_do',
            title: nls.localize(153, "&&Redo"),
            order: 2
        }, {
            menuId: MenuId.CommandPalette,
            group: '',
            title: nls.localize(154, "Redo"),
            order: 1
        }, {
            menuId: MenuId.SimpleEditorContext,
            group: '1_do',
            title: nls.localize(155, "Redo"),
            order: 2
        }]
}));
...
export const SelectAllCommand = registerCommand(new MultiCommand({
    ...
    menuOpts: [{
            ...
            group: '1_basic',
            title: nls.localize(156, "&&Select All"),
            order: 1
        }, {
            menuId: MenuId.CommandPalette,
            group: '',
            title: nls.localize(157, "Select All"),
            order: 1
        }, {
            menuId: MenuId.SimpleEditorContext,
            group: '9_select',
            title: nls.localize(158, "Select All"),
            order: 1
        }]
}));
