            ...
            switch (e.kind) {
                ...
                case 7 /* OutgoingViewModelEventKind.CursorStateChanged */: {
                    if (e.reachedMaxCursorCount) {
                        ...
                        const message = nls.localize(164, "The number of cursors has been limited to {0}. Consider using [find and replace](https://code.visualstudio.com/docs/editor/codebasics#_find-and-replace) for larger changes or increase the editor multi cursor limit setting.", multiCursorLimit);
                        this._notificationService.prompt(Severity.Warning, message, [
                            ...
                            {
                                label: nls.localize(165, 'Increase Multi Cursor Limit'),
                                run: () => {
