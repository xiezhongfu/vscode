                ...
                getActions: () => {
                    ...
                    actions.push(new Action('diff.clipboard.copyDeletedContent', isDeletion
                        ? (_diff.original.length > 1
                            ? localize(193, "Copy deleted lines")
                            : localize(194, "Copy deleted line"))
                        : (_diff.original.length > 1
                            ? localize(195, "Copy changed lines")
                            : localize(196, "Copy changed line")), undefined, true, async () => {
                    ...
                    if (_diff.original.length > 1) {
                        actions.push(new Action('diff.clipboard.copyDeletedLineContent', isDeletion
                            ? localize(197, "Copy deleted line ({0})", _diff.original.startLineNumber + currentLineNumberOffset)
                            : localize(198, "Copy changed line ({0})", _diff.original.startLineNumber + currentLineNumberOffset), undefined, true, async () => {
                    ...
                    if (!readOnly) {
                        actions.push(new Action('diff.inline.revertChange', localize(199, "Revert this change"), undefined, true, async () => {
