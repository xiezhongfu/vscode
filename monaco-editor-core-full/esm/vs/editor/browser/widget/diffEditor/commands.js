...
export class ToggleCollapseUnchangedRegions extends Action2 {
    constructor() {
        super({
            ...
            title: localize2(166, 'Toggle Collapse Unchanged Regions'),
            icon: Codicon.map,
...
export class ToggleShowMovedCodeBlocks extends Action2 {
    constructor() {
        super({
            ...
            title: localize2(167, 'Toggle Show Moved Code Blocks'),
            precondition: ContextKeyExpr.has('isInDiffEditor'),
        });
    }
    run(accessor, ...args) {
...
export class ToggleUseInlineViewWhenSpaceIsLimited extends Action2 {
    constructor() {
        super({
            ...
            title: localize2(168, 'Toggle Use Inline View When Space Is Limited'),
            precondition: ContextKeyExpr.has('isInDiffEditor'),
        });
    }
    run(accessor, ...args) {
...
const diffEditorCategory = localize2(169, "Diff Editor");
export class SwitchSide extends EditorAction2 {
    constructor() {
        super({
            id: 'diffEditor.switchSide',
            title: localize2(170, 'Switch Side'),
...
export class ExitCompareMove extends EditorAction2 {
    constructor() {
        super({
            ...
            title: localize2(171, 'Exit Compare Move'),
            icon: Codicon.close,
...
export class CollapseAllUnchangedRegions extends EditorAction2 {
    constructor() {
        super({
            ...
            title: localize2(172, 'Collapse All Unchanged Regions'),
            icon: Codicon.fold,
            precondition: ContextKeyExpr.has('isInDiffEditor'),
            f1: true,
            category: diffEditorCategory,
...
export class ShowAllUnchangedRegions extends EditorAction2 {
    constructor() {
        super({
            ...
            title: localize2(173, 'Show All Unchanged Regions'),
            icon: Codicon.unfold,
            precondition: ContextKeyExpr.has('isInDiffEditor'),
            f1: true,
            category: diffEditorCategory,
...
export class AccessibleDiffViewerPrev extends Action2 {
    ...
    constructor() {
        super({
            ...
            title: localize2(177, 'Go to Previous Difference'),
            category: accessibleDiffViewerCategory,
            precondition: ContextKeyExpr.has('isInDiffEditor'),
            keybinding: {
