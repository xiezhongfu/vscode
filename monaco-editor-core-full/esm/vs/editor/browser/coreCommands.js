...
(function (CoreNavigationCommands) {
        ...
        metadata: {
            ...
            args: [{
                    ...
                    schema: {
                        ...
                        properties: {
                            'sticky': {
                                description: nls.localize(147, "Stick to the end even when going to longer lines"),
                                type: 'boolean',
                                default: false
                            }
                        }
        ...
        metadata: {
            ...
            args: [{
                    ...
                    schema: {
                        ...
                        properties: {
                            'sticky': {
                                description: nls.localize(148, "Stick to the end even when going to longer lines"),
                                type: 'boolean',
                                default: false
                            }
                        }
    ...
    CoreNavigationCommands.RemoveSecondaryCursors = registerEditorCommand(new class extends CoreEditorCommand {
        ...
        runCoreEditorCommand(viewModel, args) {
            ...
            viewModel.revealAllCursors(args.source, true);
            status(nls.localize(149, "Removed secondary cursors"));
        }
    });
